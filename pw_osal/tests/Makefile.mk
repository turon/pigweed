...
INCLUDES =                                            \
    -I.                                               \
    -I$(PROJ_ROOT)/pw_osal/public                     \
    -I$(PROJ_ROOT)/pw_osal/$(TARGET_OSAL)             \
    -I$(PROJ_ROOT)/pw_polyfill/public                 \
    -I$(PROJ_ROOT)/pw_preprocessor/public             \
    -I$(PROJ_ROOT)/pw_span/public                     \
    -I$(PROJ_ROOT)/pw_status/public                   \
    -I$(PROJ_ROOT)/pw_sys_io/public                   \
    -I$(PROJ_ROOT)/pw_unit_test/public                \
    -I$(PROJ_ROOT)/pw_unit_test/public_overrides      \
    $(TARGET_INCLUDES)                                \
    $(NULL)
...
OSAL_PATH = $(PROJ_ROOT)/pw_osal/$(TARGET_OSAL)

TARGET_SRCS =                                            \
    $(PROJ_ROOT)/pw_unit_test/framework.cc               \
    $(PROJ_ROOT)/pw_unit_test/framework_test.cc          \
    $(PROJ_ROOT)/pw_unit_test/simple_printing_main.cc    \
    $(NULL)
